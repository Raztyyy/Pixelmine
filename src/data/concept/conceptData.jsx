    ...
    content: (
      <>
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          enables users to transition smoothly across distinct platforms while
          preserving their identities and social connections. As a result, users
          are empowered to establish their communities across multiple
          applications without forfeiting their network access.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          third parties, thereby promoting a heightened sense of security among
          users.
        </p>
      </>
    ),
    ...
    content: (
      <>
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          to the suppression of content or voices influenced by political,
          commercial, or ideological pressures. This quality fosters an
          environment conducive to diverse viewpoints and open discussions,
          thereby upholding the fundamental principles of free speech.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          cryptocurrency tokens, which can be earned through activities such as
          content creation, moderation, or community participation. By
          integrating points system, these platforms incentivize the production
        ...
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          offline social interactions. Each platform employs distinct approaches
        ...
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          among a broader demographic. The following are the various processes
          and documents that we manage.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          these characteristics to those of traditional social networks,
          highlighting the distinct advantages offered by decentralized systems
          in fostering an open discourse environment.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p className="mb-2 text-sm text-gray-600 sm:text-base dark:text-stone-50">
          ...
          interactions to effectively illustrate these concepts.
        </p>
      </>
    ),
  },
