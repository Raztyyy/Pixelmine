      ...
      <div className="pt-[3rem] pb-[3rem] px-6 mx-auto max-w-full lg:max-w-7xl lg:px-8">
        <section className="mb-8">
          <p className="text-gray-600 text-sm/6">
            1. In these Terms, "personal information" refers to information that
            falls under Article 2, Paragraph 1 of the Act on the Protection of
        ...
        <section className="mb-8">
          ...
          <ol className="ml-5 text-gray-600 list-disc list-inside text-sm/6">
        ...
        <section className="mb-8">
          <p className="text-gray-600 text-sm/6">
            3. We will never provide Personal Data to a third party, except when
            we have obtained prior consent from the user or when permitted by
            the Act on the Protection of Personal Information or other relevant
        ...
        <section className="mb-8">
          <p className="text-gray-600 text-sm/6">
            ...
            personal information with the contractor, and conduct necessary and
            appropriate supervision of the contractor.
          </p>
        </section>
        <section className="mb-8">
          <p className="text-gray-600 text-sm/6">
            5. In the event that we receive a request from a user for
            disclosure, correction, cessation of use, deletion, or suspension of
            provision to third parties regarding their personal information, we
            will respond appropriately and promptly in accordance with the Act
